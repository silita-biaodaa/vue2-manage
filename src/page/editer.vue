<template>
    <el-container>
        ...
        <el-row style="margin-top: 30px">
            <el-col :span="12">
                <div class="grid-content bg-purple">统一社会信用代码：</div>
            </el-col>
            <el-col :span="12">
        ...
        <el-row style="margin-top: 30px">
            <el-col :span="12">
                <div class="grid-content bg-purple">企业名称变更：</div>
            </el-col>
            <el-col :span="12">
                <div style="text-align: right" class="grid-content bg-purple-light">
        ...
        <el-row style="margin-top: 30px">
            <el-col :span="12">
                <div class="grid-content bg-purple">安许证号：</div>
            </el-col>
            <el-col :span="12">
                <div style="text-align: right" class="grid-content bg-purple-light">
                    <el-button type="primary">保存</el-button>
        ...
        <el-row :gutter="20" style="line-height:40px;margin-left: 10%;">
            <el-col :span="12">
                <div class="grid-content bg-purple">人工处理：安许证号（湘jz安许证字000000000000）</div>
            </el-col>
            <el-col :span="12">
                <div class="grid-content bg-purple">有效期：2019年9月10日
        ...
        <el-row style="margin-top: 30px">
            <el-col :span="12">
                <div class="grid-content bg-purple">企业资质：</div>
            </el-col>
            <el-col :span="12">
                <div style="text-align: right" class="grid-content bg-purple-light">
                    <el-button type="primary">增加</el-button>
