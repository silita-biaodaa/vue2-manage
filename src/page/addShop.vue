...
<el-row>
  <el-row class='baa_ai'>
<el-select class="baa_ui"  v-model="value7" placeholder="请选择">
    <el-option-group
  ...
  <br>
  <el-tag class='bdd_yo'>已处理公告：1000</el-tag>
  <el-tag>未处理公告：1000</el-tag>
  <el-tag>已审核公告：1000</el-tag>
  <el-tag>未处理公告：1000</el-tag>
  <el-tag>已审核公告：1000</el-tag>
 </el-row>
 <el-row class='baa_ai'>
	<el-tag  type="success">筛选</el-tag>
  	<el-tag type="success">所属地区:
   <el-cascader
  :options="options2"
...
></el-cascader>
    ...
    <el-tag type="success">公告状态：<el-select v-model="value" placeholder="请选择"><el-option
      ...
      :value="item.value">
    	...
    	<el-tag type="success">发布日期：</el-tag>
       <div class="block">
    <el-date-picker
      v-model="value1"
      type="date"
 ...
 <el-row class="bdd_so">
  <el-input placeholder="请输入内容" v-model="input5" class="input-with-select bdd_mi">
