...
<script>
import { checkType, queryList, curd, deleteApi, addAlias, uploadAlias, delectAlias, showAlias, showLevel, addLevel, showtLevel, addtAlias, selectAlias, amendAlias, firstgrade, secondLevel, addtLevel, showgrade, delgrade } from "@/api/index";
