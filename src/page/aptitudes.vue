      ...
      <el-col :span="12" class="right">
        ...
        <div class="alia">
          ...
          <div class="right-search">
            ...
            <el-upload class="updown-list" action="http://admin.biaodaa.com/upload/quaAlias/" :on-preview="handlePreview" :data="sendCode()" :on-success="handleSuccess" :headers="setHeader()" :before-remove="beforeRemove" :show-file-list='false' multiple  v-show='changebut' :on-exceed="handleExceed" :file-list="fileList">
