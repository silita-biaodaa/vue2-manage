      ...
      <div class="drcfb mb20">
        <el-row :span="24">
          ...
          <el-col :span="8" class="addAlias">
            <div class="addAlias_btn dfcc">
              <img src="../../assets/img/add_icon.png" alt />
              <div class="fs16 color-fff fw600 ml10 cp" @click="addQualList" v-show="isAllows">添加资质</div>
            </div>
          </el-col>
        </el-row>
      </div>
      ...
      <el-row>
        <el-col>
          ...
          <el-col class="changeLevel pt20 pl20 pb40" v-show="activeIndex == '2'">
            ...
            <div class="text-c levelBottomBtn">
              <button class="fs16 color-fff cp" plain v-if="levelBtn" @click="changeLevelBtn" v-show="isAllows">修改等级</button>
            </div>
          </el-col>
          <el-col class="changeMode pt20 pl20 pb40" v-show="activeIndex == '3'">
            ...
            <div class="text-c modeBottomBtn">
              <button class="fs16 color-fff cp" plain @click="changeModeBtn" v-show="isAllows">修改属性</button>
            </div>
          </el-col>
        </el-col>
      </el-row>
