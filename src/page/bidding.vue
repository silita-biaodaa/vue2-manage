              ...
              <el-row>
                  ...
                  <el-col :span="12" class="right-c">                  
                      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" background-color='#EBEEF5' menu-trigger='click' >
                        ...
                        <el-menu-item index="2" >变更</el-menu-item> 
                      </el-menu>
                  </el-col>
              </el-row>
            </el-col>
         ...
         <el-col :span='12'  class="redact-c" >
            <el-form ref="edits" :model="bidForm" label-width="200px" class="demo-ruleForm"  >
                ...
                <el-form-item label="项目县区" >
                    <!-- <div class="labe"><i class="el-icon-warning"></i>项目地区</div> -->
                    <el-select v-model="bidForm.cityCodeName" filterable placeholder="请选择项目县区" style="width:80%">
                ...
                <el-form-item label="项目类型" >
                    <el-select v-model="bidForm.proType" filterable placeholder="请选择项目类型" style="width:80%">
                      <el-option v-for="item in bidType" :key="item.areaCode"  :label="item.areaName" :value="item.areaCode">
                      </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="招标类型" >
                    <el-select v-model="bidForm.binessType" filterable placeholder="请选择招标类型" style="width:80%">
                      <el-option v-for="item in bidbiness" :key="item.areaCode"  :label="item.areaName" :value="item.areaCode">
                      </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="评标办法" >
                    <el-select v-model="bidForm.pbMode" filterable placeholder="请选择招标类型" style="width:80%">
                      <el-option v-for="item in bidbiness" :key="item.areaCode"  :label="item.areaName" :value="item.areaCode">
                      </el-option>
                    </el-select>
                </el-form-item>
...
import { updateStatus,bidList,delDidList,bidFiles,listreli,listTenders,bidRela,bidzhaoList,biddelList } from '@/api/index'
export default {
  data () {
     return {
        pkid:'',
